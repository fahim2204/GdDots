      ...
      <section className="text-gray-600">
        <div className="px-8 py-12 grid lg:grid-cols-2 item-center">
          <div className="mt-auto mb-auto grid md:grid-cols-2 gap-12">
            <div class="w-full p-6 bg-white-800 text-center mb-4 py-16 rounded-3xl shadow-xl border-2 border-gray-200 ">
            ...
            <div class="w-full p-6 bg-white-800 text-center py-16 mb-4 rounded-3xl shadow-xl border-2 border-gray-200">
