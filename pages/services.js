      ...
      <section className="max-w-6xl mx-auto px-5">
        <div className="py-12 mx-auto">
          <div className="flex mb-5 flex-col items-center text-center">
            <h1 className="text-4xl sm:text-5xl mb-10 text-gray-900 uppercase tracking-wider font-sans">
          ...
          <div className="justify-center text-center items-center mx-auto gap-4 md:gap-8 lg:gap-16 grid sm:grid-cols-2 md:grid-cols-3">
            <div class="h-full p-6 text-center mb-4 rounded-3xl drop-shadow-md bg-white border border-gray-200 hover:bg-orange-600 text-gray-900 hover:text-white cursor-pointer transition ease-in duration-300 ">
